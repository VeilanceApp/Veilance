export const TELEMETRY_SCHEMA_VERSION = "veilance.telemetry.v0.3";
...
export function buildSanitizedPayload(state, extensionVersion = "0.0.0", now = Date.now()) {
  ...
  return {
    ...
    exclusions: [
      ...
      "browser and device characteristic values",
      "screen, locale, time-zone, font, and network values",
      "peripheral identifiers and sensor readings",
      "credential and authenticator data",
      "local file names and contents",
      "speech audio, recognized text, and voice details",
      "advertising topics, auction data, and shared-storage contents"
    ]
  };
}
